...
"use strict"; // 변수명 - 소문자로 시작하는 카멜케이스
...
var NewsFeedView = function (_super) {
  ...
  function NewsFeedView(containerId) {
    ...
    return _this; // store.totalPage = this.feeds.length / 10;
  }
